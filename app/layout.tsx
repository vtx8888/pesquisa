  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL@20..48,400,0..1&icon_names=arrow_back,arrow_forward,chat,check,check_circle,lock,mail,person&display=block"
          rel="stylesheet"
        />
        {/* Google Tag Manager */}
